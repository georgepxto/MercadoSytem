...
<div class="row">
    ...
    <div class="col-md-6 col-lg-4 mb-4">
        <div class="card h-100 {{ $box->available ? '' : 'border-warning' }}">
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-start mb-3">
                    <div>
                        ...
                        <p class="text-muted mb-0">{{ $box->location }}</p>
                    </div>
                    <div class="text-end">
                        @if($box->available)
                ...
                @if($box->monthly_price)
                    <div class="mb-3">
                        <h6 class="text-primary">R$ {{ number_format($box->monthly_price, 2, ',', '.') }}/mês</h6>
                    </div>
                @endif
                ...
                @if($box->schedules->count() > 0)
                    <div class="mb-3">
                        <h6 class="text-muted">Horários Ocupados:</h6>
                            ...
                            @if($schedule->active)
                                <div class="d-flex justify-content-between small mb-2 p-2 bg-light rounded">
                                    <div>
                                        ...
                                        <span class="text-muted">{{ $schedule->vendor->food_type }}</span>
                                    </div>
                                    <div class="text-end">
                                        <span class="badge bg-secondary">{{ ucfirst($schedule->day_of_week) }}</span><br>
